                    ...
                    <div className="testimonial bottom">
                        ...
                        <div className="media">
                            ...
                            <div className="media-body">
                                <blockquote>One of the only ways to get out of a tight box is to invent your way out.</blockquote>
                        ...
                        <div className="media">
                            ...
                            <div className="media-body">
                                <blockquote>If you double the number of experiments you do per year you’re going to double your inventiveness</blockquote>

...
const Footer_Recruitment = (props) => {
                    ...
                    <div className="testimonial bottom">
                        ...
                        <div className="media">
                            ...
                            <div className="media-body">
                                <blockquote>our core values and approach remain unchanged. 
                                        We continue to aspire to be Earth’s most customer-centric company.</blockquote>
                        ...
                        <div className="media">
                            ...
                            <div className="media-body">
                                <blockquote>There's this new generation of systems integrators that's really picked up steam, and
                                     that's carrying a lot of the new market segment share in companies moving to cloud,</blockquote>
    ...
    export default Footer_Recruitment;